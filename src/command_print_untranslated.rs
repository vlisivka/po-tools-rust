...
mod tests {
    ...
    #[test]
    fn test_untranslated_positive() -> Result<()> {
        let mut out = Vec::new();
        let mut err = Vec::new();
        ...
        command_print_untranslated(&parser, &[f.path().to_str().unwrap()], &mut ctx)?;
    ...
    fn test_help() -> Result<()> {
        ...
        command_print_untranslated(&parser, &["--help"], &mut ctx)?;
    ...
    fn test_no_files() -> Result<()> {
        ...
        let result = command_print_untranslated(&parser, &[], &mut ctx);
