...
fn help() {
  println!("Usage: po-tools [OPTIONS] [--] parse|merge|diff|diffstr|translate|added|deleted|translated|untranslated|regular|plural|with-context|translated-untranslated [...]");
  // TODO
}

fn help_parse() {
  println!("Usage: po-tools [OPTIONS] [--] parse [OPTIONS] FILE");
  // TODO
}

fn help_translate() {
  println!("Usage: po-tools [OPTIONS] [--] translate [-m MODEL|-l LANG] FILE");
  // TODO
}
