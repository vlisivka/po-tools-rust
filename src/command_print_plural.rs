...
mod tests {
    ...
    #[test]
    fn test_plural_positive() -> Result<()> {
        let mut out = Vec::new();
        let mut err = Vec::new();
        ...
        command_print_plural(&parser, &[f.path().to_str().unwrap()], &mut ctx)?;
    ...
    fn test_help() -> Result<()> {
        ...
        command_print_plural(&parser, &["--help"], &mut ctx)?;
    ...
    fn test_no_files() -> Result<()> {
        ...
        let result = command_print_plural(&parser, &[], &mut ctx);
